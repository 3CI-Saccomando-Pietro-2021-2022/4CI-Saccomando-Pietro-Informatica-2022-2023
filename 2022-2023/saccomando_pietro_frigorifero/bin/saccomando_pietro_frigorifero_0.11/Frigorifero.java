public class Frigorifero{
    ...
    public void setTempFrigo(int tempFrigo){
            this.temperaturaFrigo=tempFrigo;
    }
    public void aumentaTempFrigo(){
        this.temperaturaFrigo++;
    }
    public void diminuisciTempFrigo(){
        this.temperaturaFrigo--;
    }
    public int getTempFrigo(){
        return this.temperaturaFrigo;
    }
    public void setTempFreezer(int tempFreezer){
            this.temperaturaFreezer=tempFreezer;
    }
    public void aumentaTempFreezer(){
        this.temperaturaFreezer++;
    }
    public void diminuisciTempFreezer(){
        this.temperaturaFreezer--;
    }
